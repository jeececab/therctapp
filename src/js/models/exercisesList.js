...
export const exercisesList = baseExercises.concat(skillExercises, strengthExercises, powerExercises, endurExercises, perfExercises, aeroExercises, crossExercises);